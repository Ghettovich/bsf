...
//DetectionSensorForm *IODeviceFormFactory::createDetectionSensorForm(QWidget * _parent, DetectionSensor* ioDevice) {
//    return new DetectionSensorForm(_parent, Qt::Widget, ioDevice);
//}
//
//RelayForm *IODeviceFormFactory::createRelayForm(QWidget * parent, Relay * ioDevice) {
